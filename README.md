...
Laravel Database Trigger requires at least [PHP](https://php.net) 7.4. This particular version supports Laravel v6.20.*. For other older versions of Laravel check v1 and v2 branches.
